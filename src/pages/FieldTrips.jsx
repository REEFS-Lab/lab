                  ...
                  <div className="row">
                    <div className="col-md-4">
                      <div className="people-card-img">
                        <Link to={`/field-visits/${item.Title}`}><img src={item.ThumbnailImg} alt='People' /></Link>
                      </div>
                    </div>
                    <div className="col-md-8">
                      <div className="people-card-content">
                        <Link to={`/field-visits/${item.Title}`}>
                          <h2>{item.Title}</h2>
                        </Link>
                      ...
                      <div className="card-lg-container-btn">
                        <Link to={`/field-visits/${item.Title}`}><button className="card-lg-btn">Read More </button></Link>
                      </div>
                    </div>
                  </div>
              </div>
