                ...
                <div className="nav__content bd-grid">
                    <div className="nav__menu">
                        <ul>
                            ...
                            <li className="nav__item">
                                <NavLink to="/field-visits" className="nav__link" onClick={handleLinkClick}>
                                Field Visits
                                </NavLink>
                            </li>
                            <li className="nav__item">
                                <NavLink to="/conferences" className="nav__link" onClick={handleLinkClick}>
                                Conferences
                                </NavLink>
                            </li>
                            ...
                            <li className="nav__item">
                                <NavLink to="/recent-news" className="nav__link" onClick={handleLinkClick}>
                                Recent News
                                </NavLink>
                            </li>
                            <li className="nav__item">
                                <NavLink to="/blogs" className="nav__link" onClick={handleLinkClick}>
                                Blogs
                                </NavLink>
                            </li>
                            {/* <li className="nav__item">
